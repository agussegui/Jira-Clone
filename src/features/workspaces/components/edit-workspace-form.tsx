...
export const EditWorkspaceForm = ({onCancel, initialValues}: EditWorkspaceFormProps) => {
    ...
    const handleCopyInviteLink = () => {
        navigator.clipboard.writeText(fullInviteLink)
            .then(() => toast.success("Enlace de invitación copiado"))
    }
    ...
    return (
        <div className="flex flex-col gap-y-4">
            ...
            <Card className="w-full h-full border-none shadow-none">
                ...
                <CardTitle className="text-xl font-bold ml-8">
                    {initialValues.name}
                </CardTitle>
                <div className="px-7">
                    <DottedSeparator/>
                                        ...
                                        <div className="flex flex'col gap-y-2">
                                            <div className="flex items-center gap-x-5">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <p className="text-sm text-muted-foreground">JPG, PNG, SVG O JPEG, max 1MB </p>
                                                    <input 
                                                        type="file" 
                                                        className="hidden"
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        <h3 className="font-bold">Invitar Miembros</h3>   
                        <p className="text-sm text-muted-foreground">
                            Usa el link de invitación para agregar miembros a tu Area de Trabajo.       
                        </p>             
                        <div className="mt-4">
                        ...
                        <DottedSeparator className="size-7"/>
                        <Button 
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        <h3 className="font-bold">Zona Peligrosa</h3>   
                        <p className="text-sm text-muted-foreground">
                            Eliminar un espacio de trabajo es irreversible y eliminará todos los datos asociados.            
                        </p>             
                        <Button 
                            className="mt-6 w-fit ml-auto"
                            size="sm"
