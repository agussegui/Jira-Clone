...
const app = new Hono()
    ...
    .patch(
        ...
        async(c) => {
            ...
            if(!member || member.role !== MemberRole.ADMIN){
                return c.json({error: "Unanthorized"}, 401);
            }
    ...
    .post(
        ...
        async(c) => {
            ...
            if(member){
                return c.json({error: "Ya tienes un miembro"}, 400)
            }
            ...
            if(workspace.inviteCode !== code) {
                return c.json({error: "codigo de invitacion invalido"}, 400)
            }
    ...
    .get(
            ...
            async(c) => {
                ...
                const thisMonthIncompleteTasks = await databases.listDocuments(
                    ...
                    [
                        Query.equal("workspaceId", workspaceId),
                        Query.notEqual("status", TaskStatus.TERMINADO),
                        Query.greaterThanEqual("$createdAt", thisMonthStart.toISOString()),
                        Query.lessThanEqual("$createdAt", thisMonthEnd.toISOString()),
                    ]
                );
                ...
                const thisMonthCompletedTasks = await databases.listDocuments(
                    ...
                    [
                        Query.equal("workspaceId", workspaceId),
                        Query.equal("status", TaskStatus.TERMINADO),
                        Query.greaterThanEqual("$createdAt", thisMonthStart.toISOString()),
                        Query.lessThanEqual("$createdAt", thisMonthEnd.toISOString()),
                    ]
                );
